...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    await hass.config_entries.async_forward_entry_setups(entry, ["sensor", "image", "button"])
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if not await hass.config_entries.async_unload_platforms(entry, ["sensor", "image", "button"]):
        return False
